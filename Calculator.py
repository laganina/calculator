...
class Calculator():
    def __init__(self,master):
        ...
        self.entry_value=''
        Entry(width=17, bg='light blue', font=('Roboto', 28), textvariable=self.equation).place(x=0,y=0)
        ...
        Button(width=11,height=4,text='C',relief='flat',bg='pink',command=lambda:self.clear).place(x=0,y=350)
